...
public class Class44_Sub3_Sub4_Sub5 extends Class44_Sub3_Sub4
{
    ...
    public void method531(int i, int j)
    {
        try
        {
            ...
            for(anInt1611 += j; anInt1611 > aClass32_1604.aClass26_563.getLength(anInt1610);)
            {
                anInt1611 -= aClass32_1604.aClass26_563.getLength(anInt1610) + 1;
                anInt1610++;
                if(anInt1610 >= aClass32_1604.aClass26_563.frame_count && (anInt1610 < 0 || anInt1610 >= aClass32_1604.aClass26_563.frame_count))
                {
                    anInt1610 = 0;
                    aBoolean1612 = true;
                }
    ...
    public Model method499(int i)
    {
        try
        {
            ...
            int k = aClass32_1604.aClass26_563.frame_index[anInt1610];
            Model class44_sub3_sub4_sub4_1 = new Model(class44_sub3_sub4_sub4, AnimationFrame.invalid(k), false, anInt1602, true);
            if(!aBoolean1612)
            {
            ...
            {
                class44_sub3_sub4_sub4_1.scale(aClass32_1604.anInt566, aClass32_1604.anInt566, aClass32_1604.anInt567, (byte)31);
            }
            ...
            class44_sub3_sub4_sub4_1.applyLighting(64 + aClass32_1604.anInt569, 850 + aClass32_1604.anInt570, -30, -50, -30, true);
