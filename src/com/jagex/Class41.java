...
public class Class41
{
    ...
    {
        Buffer class44_sub3_sub2 = new Buffer(class47.entry("fragmentsenc.txt", null));
        Buffer class44_sub3_sub2_1 = new Buffer(class47.entry("badenc.txt", null));
        Buffer class44_sub3_sub2_2 = new Buffer(class47.entry("domainenc.txt", null));
        Buffer class44_sub3_sub2_3 = new Buffer(class47.entry("tldlist.txt", null));
        method343(class44_sub3_sub2, class44_sub3_sub2_1, class44_sub3_sub2_2, class44_sub3_sub2_3);
    }

    public static void method343(Buffer class44_sub3_sub2, Buffer class44_sub3_sub2_1, Buffer class44_sub3_sub2_2, Buffer class44_sub3_sub2_3)
    {
    ...
    public static void method344(int i, Buffer class44_sub3_sub2)
    {
        try
        {
            ...
            int j = class44_sub3_sub2.getUnsignedInt();
    ...
    public static void method346(boolean flag, Buffer class44_sub3_sub2)
    {
        try
        {
            int i = class44_sub3_sub2.getUnsignedInt();
    ...
    public static void method347(Buffer class44_sub3_sub2, byte byte0)
    {
        try
        {
            anIntArray756 = new int[class44_sub3_sub2.getUnsignedInt()];
            for(int i = 0; i < anIntArray756.length; i++)
            {
                anIntArray756[i] = class44_sub3_sub2.getUnsignedShort();
            }
            if(byte0 != -47)
            {
                for(int j = 1; j > 0; j++)
    ...
    public static void method350(char ac[], int i)
    {
        ...
        {
            signlink.reporterror("15486, " + new String(ac) + ", " + i + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public static void method353(char ac[], char ac1[], boolean flag)
    {
        ...
        {
            signlink.reporterror("96470, " + new String(ac) + ", " + new String(ac1) + ", " + flag + ", " + runtimeexception.toString());
            throw new RuntimeException();
        }
    }
    ...
    public static void method354(char ac[], byte byte0)
    {
        ...
        {
            signlink.reporterror("60830, " + new String(ac) + ", " + byte0 + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public static void method355(byte byte0, char ac[])
    {
        ...
        {
            signlink.reporterror("661, " + byte0 + ", " + new String(ac) + ", " + runtimeexception.toString());
            throw new RuntimeException();
        }
    }
    ...
    public static void method356(int i, char ac[])
    {
        ...
        {
            signlink.reporterror("89247, " + i + ", " + new String(ac) + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public static void method357(char ac[], char ac1[], char ac2[], byte byte0, char ac3[])
    {
        ...
        {
            signlink.reporterror("13466, " + new String(ac) + ", " + new String(ac1) + ", " + new String(ac2) + ", " + byte0 + ", " + new String(ac3) + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public static int method358(int i, char ac[], int j, char ac1[])
    {
        ...
        {
            signlink.reporterror("36104, " + i + ", " + new String(ac) + ", " + j + ", " + new String(ac1) + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public static int method359(char ac[], char ac1[], int i, int j)
    {
        ...
        {
            signlink.reporterror("83310, " + new String(ac) + ", " + new String(ac1) + ", " + i + ", " + j + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public static void method360(char ac[], int i)
    {
        ...
        {
            signlink.reporterror("75731, " + new String(ac) + ", " + i + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public static void method361(int i, int j, char ac[], char ac1[], char ac2[], char ac3[])
    {
        ...
        {
            signlink.reporterror("11090, " + i + ", " + j + ", " + new String(ac) + ", " + new String(ac1) + ", " + new String(ac2) + ", " + new String(ac3) + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public static int method362(int i, char ac[], boolean flag, char ac1[])
    {
        ...
        {
            signlink.reporterror("59837, " + i + ", " + new String(ac) + ", " + flag + ", " + new String(ac1) + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public static int method363(char ac[], char ac1[], byte byte0, int i)
    {
        ...
        {
            signlink.reporterror("32535, " + new String(ac) + ", " + new String(ac1) + ", " + byte0 + ", " + i + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public static void method364(char ac[], char ac1[], byte abyte0[][], int i)
    {
        ...
        {
            signlink.reporterror("88077, " + new String(ac) + ", " + new String(ac1) + ", " + abyte0 + ", " + i + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public static void method369(char ac[], int i)
    {
        ...
        {
            signlink.reporterror("48666, " + new String(ac) + ", " + i + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public static int method370(int i, int j, char ac[])
    {
        ...
        {
            signlink.reporterror("33082, " + i + ", " + j + ", " + new String(ac) + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public static int method371(char ac[], int i, boolean flag)
    {
        ...
        {
            signlink.reporterror("23776, " + new String(ac) + ", " + i + ", " + flag + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public static boolean method378(char ac[], int i)
    {
        ...
        {
            signlink.reporterror("32549, " + new String(ac) + ", " + i + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public static int method379(char ac[], byte byte0)
    {
        ...
        {
            signlink.reporterror("24004, " + new String(ac) + ", " + byte0 + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
