...
public class Rasterizer extends DrawingArea
{
    ...
    public static void method419(byte byte0)
    {
        try
        {
            anIntArray1429 = new int[DrawingArea.anInt1371];
            if(byte0 == 3)
            {
                byte0 = 0;
            } else
            ...
            for(int i = 0; i < DrawingArea.anInt1371; i++)
            {
                anIntArray1429[i] = DrawingArea.anInt1370 * i;
            }
            anInt1423 = DrawingArea.anInt1370 / 2;
            anInt1424 = DrawingArea.anInt1371 / 2;
            return;
        }
        catch(RuntimeException runtimeexception)
        {
    ...
    public static void setBrightness(double d, int i)
    {
        try
        {
            ...
            int i2)
    {
        ...
        if(i <= j && i <= k)
        {
            if(i >= DrawingArea.anInt1373)
            {
                return;
            }
            if(j > DrawingArea.anInt1373)
            {
                j = DrawingArea.anInt1373;
            }
            if(k > DrawingArea.anInt1373)
            {
                k = DrawingArea.anInt1373;
            }
            if(j < k)
            {
                j1 = l <<= 16;
                ...
                if(i != j && j3 < j2 || i == j && j3 > l2)
                {
                    k -= j;
                    j -= i;
                    for(i = anIntArray1429[i]; --j >= 0; i += DrawingArea.anInt1370)
                    {
                        method430(DrawingArea.anIntArray1369, i, 0, 0, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
                        j1 += j3;
                        l += j2;
                        i2 += k3;
                        k1 += k2;
                    ...
                    while(--k >= 0)
                    {
                        method430(DrawingArea.anIntArray1369, i, 0, 0, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
                        j1 += j3;
                        i1 += l2;
                        i2 += k3;
                        l1 += i3;
                        i += DrawingArea.anInt1370;
                    }
                    return;
                }
                k -= j;
                ...
                for(i = anIntArray1429[i]; --j >= 0; i += DrawingArea.anInt1370)
                {
                    method430(DrawingArea.anIntArray1369, i, 0, 0, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
                    j1 += j3;
                    l += j2;
                    i2 += k3;
                    k1 += k2;
                ...
                while(--k >= 0)
                {
                    method430(DrawingArea.anIntArray1369, i, 0, 0, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
                    j1 += j3;
                    i1 += l2;
                    i2 += k3;
                    l1 += i3;
            ...
            if(i != k && j3 < j2 || i == k && l2 > j2)
            {
                j -= k;
                k -= i;
                for(i = anIntArray1429[i]; --k >= 0; i += DrawingArea.anInt1370)
                {
                    method430(DrawingArea.anIntArray1369, i, 0, 0, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
                    i1 += j3;
                    l += j2;
                    l1 += k3;
                    k1 += k2;
            ...
            for(i = anIntArray1429[i]; --k >= 0; i += DrawingArea.anInt1370)
            {
                method430(DrawingArea.anIntArray1369, i, 0, 0, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
                i1 += j3;
                l += j2;
                l1 += k3;
                k1 += k2;
        ...
        if(j <= k)
        {
            ...
            if(k < i)
            {
                ...
                if(j != k && j2 < l2 || j == k && j2 > j3)
                {
                    i -= k;
                    k -= j;
                    for(j = anIntArray1429[j]; --k >= 0; j += DrawingArea.anInt1370)
                    {
                        method430(DrawingArea.anIntArray1369, j, 0, 0, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
                        l += j2;
                        i1 += l2;
                        k1 += k2;
                        l1 += i3;
                    ...
                    while(--i >= 0)
                    {
                        method430(DrawingArea.anIntArray1369, j, 0, 0, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
                        l += j2;
                        j1 += j3;
                        k1 += k2;
                        i2 += k3;
                        j += DrawingArea.anInt1370;
                    }
                    return;
                }
                i -= k;
                ...
                for(j = anIntArray1429[j]; --k >= 0; j += DrawingArea.anInt1370)
                {
                    method430(DrawingArea.anIntArray1369, j, 0, 0, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
                    l += j2;
                    i1 += l2;
                    k1 += k2;
                    l1 += i3;
                ...
                while(--i >= 0)
                {
                    method430(DrawingArea.anIntArray1369, j, 0, 0, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
                    l += j2;
                    j1 += j3;
                    k1 += k2;
                    i2 += k3;
            ...
            if(j2 < l2)
            {
                k -= i;
                i -= j;
                for(j = anIntArray1429[j]; --i >= 0; j += DrawingArea.anInt1370)
                {
                    method430(DrawingArea.anIntArray1369, j, 0, 0, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
                    j1 += j2;
                    i1 += l2;
                    i2 += k2;
                    l1 += i3;
            ...
            for(j = anIntArray1429[j]; --i >= 0; j += DrawingArea.anInt1370)
            {
                method430(DrawingArea.anIntArray1369, j, 0, 0, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
                j1 += j2;
                i1 += l2;
                i2 += k2;
                l1 += i3;
        ...
        if(i < j)
        {
            ...
            if(l2 < j3)
            {
                j -= i;
                i -= k;
                for(k = anIntArray1429[k]; --i >= 0; k += DrawingArea.anInt1370)
                {
                    method430(DrawingArea.anIntArray1369, k, 0, 0, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
                    i1 += l2;
                    j1 += j3;
                    l1 += i3;
                    i2 += k3;
                ...
                while(--j >= 0)
                {
                    method430(DrawingArea.anIntArray1369, k, 0, 0, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
                    i1 += l2;
                    l += j2;
                    l1 += i3;
                    k1 += k2;
                    k += DrawingArea.anInt1370;
                }
                return;
            }
            j -= i;
            ...
            for(k = anIntArray1429[k]; --i >= 0; k += DrawingArea.anInt1370)
            {
                method430(DrawingArea.anIntArray1369, k, 0, 0, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
                i1 += l2;
                j1 += j3;
                l1 += i3;
                i2 += k3;
            ...
            while(--j >= 0)
            {
                method430(DrawingArea.anIntArray1369, k, 0, 0, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
                i1 += l2;
                l += j2;
                l1 += i3;
                k1 += k2;
        ...
        if(l2 < j3)
        {
            i -= j;
            j -= k;
            for(k = anIntArray1429[k]; --j >= 0; k += DrawingArea.anInt1370)
            {
                method430(DrawingArea.anIntArray1369, k, 0, 0, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
                l += l2;
                j1 += j3;
                k1 += i3;
                i2 += k3;
        ...
        for(k = anIntArray1429[k]; --j >= 0; k += DrawingArea.anInt1370)
        {
            method430(DrawingArea.anIntArray1369, k, 0, 0, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
            l += l2;
            j1 += j3;
            k1 += i3;
            i2 += k3;
    ...
    public static void method430(int ai[], int i, int j, int k, int l, int i1, int j1, int k1)
    {
        if(textured)
        {
            ...
            if(aBoolean1419)
            {
                ...
                if(i1 > DrawingArea.anInt1376)
                {
                    i1 = DrawingArea.anInt1376;
                }
                if(l < 0)
                {
                    j1 -= l * l1;
    ...
    public static void method431(int i, int j, int k, int l, int i1, int j1, int k1)
    {
        ...
        if(i <= j && i <= k)
        {
            ...
            if(j < k)
            {
                ...
                if(i != j && j2 < l1 || i == j && j2 > i2)
                {
                    ...
                    for(i = anIntArray1429[i]; --j >= 0; i += DrawingArea.anInt1370)
                    {
                        method432(DrawingArea.anIntArray1369, i, k1, 0, j1 >> 16, l >> 16);
                        j1 += j2;
                        l += l1;
                    }
                    while(--k >= 0)
                    {
                        method432(DrawingArea.anIntArray1369, i, k1, 0, j1 >> 16, i1 >> 16);
                        j1 += j2;
                        i1 += i2;
                        i += DrawingArea.anInt1370;
                    }
                ...
                for(i = anIntArray1429[i]; --j >= 0; i += DrawingArea.anInt1370)
                {
                    method432(DrawingArea.anIntArray1369, i, k1, 0, l >> 16, j1 >> 16);
                    j1 += j2;
                    l += l1;
                }
                while(--k >= 0)
                {
                    method432(DrawingArea.anIntArray1369, i, k1, 0, i1 >> 16, j1 >> 16);
                    j1 += j2;
                    i1 += i2;
                    i += DrawingArea.anInt1370;
                }
            ...
            if(i != k && j2 < l1 || i == k && i2 > l1)
            {
                ...
                for(i = anIntArray1429[i]; --k >= 0; i += DrawingArea.anInt1370)
                {
                    method432(DrawingArea.anIntArray1369, i, k1, 0, i1 >> 16, l >> 16);
                    i1 += j2;
                    l += l1;
                }
                while(--j >= 0)
            ...
            for(i = anIntArray1429[i]; --k >= 0; i += DrawingArea.anInt1370)
            {
                method432(DrawingArea.anIntArray1369, i, k1, 0, l >> 16, i1 >> 16);
                i1 += j2;
                l += l1;
            }
            while(--j >= 0)
        ...
        if(j <= k)
        {
            ...
            if(k < i)
            {
                ...
                if(j != k && l1 < i2 || j == k && l1 > j2)
                {
                    ...
                    for(j = anIntArray1429[j]; --k >= 0; j += DrawingArea.anInt1370)
                    {
                        method432(DrawingArea.anIntArray1369, j, k1, 0, l >> 16, i1 >> 16);
                        l += l1;
                        i1 += i2;
                    }
                    while(--i >= 0)
                    {
                        method432(DrawingArea.anIntArray1369, j, k1, 0, l >> 16, j1 >> 16);
                        l += l1;
                        j1 += j2;
                        j += DrawingArea.anInt1370;
                    }
                ...
                for(j = anIntArray1429[j]; --k >= 0; j += DrawingArea.anInt1370)
                {
                    method432(DrawingArea.anIntArray1369, j, k1, 0, i1 >> 16, l >> 16);
                    l += l1;
                    i1 += i2;
                }
                while(--i >= 0)
                {
                    method432(DrawingArea.anIntArray1369, j, k1, 0, j1 >> 16, l >> 16);
                    l += l1;
                    j1 += j2;
                    j += DrawingArea.anInt1370;
                }
            ...
            if(l1 < i2)
            {
                ...
                for(j = anIntArray1429[j]; --i >= 0; j += DrawingArea.anInt1370)
                {
                    method432(DrawingArea.anIntArray1369, j, k1, 0, j1 >> 16, i1 >> 16);
                    j1 += l1;
                    i1 += i2;
                }
                while(--k >= 0)
            ...
            for(j = anIntArray1429[j]; --i >= 0; j += DrawingArea.anInt1370)
            {
                method432(DrawingArea.anIntArray1369, j, k1, 0, i1 >> 16, j1 >> 16);
                j1 += l1;
                i1 += i2;
            }
            while(--k >= 0)
        ...
        if(i < j)
        {
            ...
            if(i2 < j2)
            {
                ...
                for(k = anIntArray1429[k]; --i >= 0; k += DrawingArea.anInt1370)
                {
                    method432(DrawingArea.anIntArray1369, k, k1, 0, i1 >> 16, j1 >> 16);
                    i1 += i2;
                    j1 += j2;
                }
                while(--j >= 0)
                {
                    method432(DrawingArea.anIntArray1369, k, k1, 0, i1 >> 16, l >> 16);
                    i1 += i2;
                    l += l1;
                    k += DrawingArea.anInt1370;
                }
            ...
            for(k = anIntArray1429[k]; --i >= 0; k += DrawingArea.anInt1370)
            {
                method432(DrawingArea.anIntArray1369, k, k1, 0, j1 >> 16, i1 >> 16);
                i1 += i2;
                j1 += j2;
            }
            while(--j >= 0)
            {
                method432(DrawingArea.anIntArray1369, k, k1, 0, l >> 16, i1 >> 16);
                i1 += i2;
                l += l1;
                k += DrawingArea.anInt1370;
            }
        ...
        if(i2 < j2)
        {
            ...
            for(k = anIntArray1429[k]; --j >= 0; k += DrawingArea.anInt1370)
            {
                method432(DrawingArea.anIntArray1369, k, k1, 0, l >> 16, j1 >> 16);
                l += i2;
                j1 += j2;
            }
            while(--i >= 0)
        ...
        for(k = anIntArray1429[k]; --j >= 0; k += DrawingArea.anInt1370)
        {
            method432(DrawingArea.anIntArray1369, k, k1, 0, j1 >> 16, l >> 16);
            l += i2;
            j1 += j2;
        }
        while(--i >= 0)
            ...
            int l3, int i4, int j4, int k4)
    {
        ...
        if(i <= j && i <= k)
        {
            ...
            if(j < k)
            {
                ...
                if(i != j && i8 < i7 || i == j && i8 > k7)
                {
                    ...
                    while(--j >= 0)
                    {
                        method434(DrawingArea.anIntArray1369, ai, 0, 0, i, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                        j1 += i8;
                        l += i7;
                        i2 += j8;
                        k1 += j7;
                    ...
                    while(--k >= 0)
                    {
                        method434(DrawingArea.anIntArray1369, ai, 0, 0, i, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                        j1 += i8;
                        i1 += k7;
                        i2 += j8;
                        l1 += l7;
                ...
                while(--j >= 0)
                {
                    method434(DrawingArea.anIntArray1369, ai, 0, 0, i, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                    j1 += i8;
                    l += i7;
                    i2 += j8;
                    k1 += j7;
                ...
                while(--k >= 0)
                {
                    method434(DrawingArea.anIntArray1369, ai, 0, 0, i, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                    j1 += i8;
                    i1 += k7;
                    i2 += j8;
                    l1 += l7;
            ...
            if(i != k && i8 < i7 || i == k && k7 > i7)
            {
                ...
                while(--k >= 0)
                {
                    method434(DrawingArea.anIntArray1369, ai, 0, 0, i, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                    i1 += i8;
                    l += i7;
                    l1 += j8;
                    k1 += j7;
            ...
            while(--k >= 0)
            {
                method434(DrawingArea.anIntArray1369, ai, 0, 0, i, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                i1 += i8;
                l += i7;
                l1 += j8;
                k1 += j7;
        ...
        if(j <= k)
        {
            ...
            if(k < i)
            {
                ...
                if(j != k && i7 < k7 || j == k && i7 > i8)
                {
                    ...
                    while(--k >= 0)
                    {
                        method434(DrawingArea.anIntArray1369, ai, 0, 0, j, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                        l += i7;
                        i1 += k7;
                        k1 += j7;
                        l1 += l7;
                    ...
                    while(--i >= 0)
                    {
                        method434(DrawingArea.anIntArray1369, ai, 0, 0, j, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                        l += i7;
                        j1 += i8;
                        k1 += j7;
                        i2 += j8;
                ...
                while(--k >= 0)
                {
                    method434(DrawingArea.anIntArray1369, ai, 0, 0, j, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                    l += i7;
                    i1 += k7;
                    k1 += j7;
                    l1 += l7;
                ...
                while(--i >= 0)
                {
                    method434(DrawingArea.anIntArray1369, ai, 0, 0, j, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                    l += i7;
                    j1 += i8;
                    k1 += j7;
                    i2 += j8;
            ...
            if(i7 < k7)
            {
                ...
                while(--i >= 0)
                {
                    method434(DrawingArea.anIntArray1369, ai, 0, 0, j, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                    j1 += i7;
                    i1 += k7;
                    i2 += j7;
                    l1 += l7;
            ...
            while(--i >= 0)
            {
                method434(DrawingArea.anIntArray1369, ai, 0, 0, j, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                j1 += i7;
                i1 += k7;
                i2 += j7;
                l1 += l7;
        ...
        if(i < j)
        {
            ...
            if(k7 < i8)
            {
                ...
                while(--i >= 0)
                {
                    method434(DrawingArea.anIntArray1369, ai, 0, 0, k, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                    i1 += k7;
                    j1 += i8;
                    l1 += l7;
                    i2 += j8;
                ...
                while(--j >= 0)
                {
                    method434(DrawingArea.anIntArray1369, ai, 0, 0, k, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                    i1 += k7;
                    l += i7;
                    l1 += l7;
                    k1 += j7;
            ...
            while(--i >= 0)
            {
                method434(DrawingArea.anIntArray1369, ai, 0, 0, k, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                i1 += k7;
                j1 += i8;
                l1 += l7;
                i2 += j8;
            ...
            while(--j >= 0)
            {
                method434(DrawingArea.anIntArray1369, ai, 0, 0, k, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                i1 += k7;
                l += i7;
                l1 += l7;
                k1 += j7;
        ...
        if(k7 < i8)
        {
            ...
            while(--j >= 0)
            {
                method434(DrawingArea.anIntArray1369, ai, 0, 0, k, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                l += k7;
                j1 += i8;
                k1 += l7;
                i2 += j8;
        ...
        while(--j >= 0)
        {
            method434(DrawingArea.anIntArray1369, ai, 0, 0, k, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
            l += k7;
            j1 += i8;
            k1 += l7;
            i2 += j8;
