...
public class RSFont extends DrawingArea
{
    ...
    public RSFont(int i, String name, boolean flag, Archive class47)
    {
        anInt1466 = 784;
        aBoolean1467 = false;
        aByte1469 = 5;
        ...
        try
        {
            Buffer class44_sub3_sub2 = new Buffer(class47.entry(name + ".dat", null));
            Buffer class44_sub3_sub2_1 = new Buffer(class47.entry("index.dat", null));
            class44_sub3_sub2_1.pointer = class44_sub3_sub2.getUnsignedShort() + 4;
            if(i != 9)
            {
            ...
            if(k > 0)
            {
                class44_sub3_sub2_1.pointer += 3 * (k - 1);
            }
            for(int l = 0; l < 256; l++)
            {
                anIntArray1475[l] = class44_sub3_sub2_1.getUnsignedByte();
                anIntArray1476[l] = class44_sub3_sub2_1.getUnsignedByte();
                int i1 = anIntArray1473[l] = class44_sub3_sub2_1.getUnsignedShort();
                int j1 = anIntArray1474[l] = class44_sub3_sub2_1.getUnsignedShort();
                ...
                if(k1 == 0)
                {
                    ...
                    {
                        aByteArrayArray1472[l][i2] = class44_sub3_sub2.getSignedByte();
                    }
                } else
                if(k1 == 1)
                {
                    for(int j2 = 0; j2 < i1; j2++)
                    {
                        ...
                        {
                            aByteArrayArray1472[l][j2 + l2 * i1] = class44_sub3_sub2.getSignedByte();
                        }
                    }
                }
        ...
        {
            signlink.reporterror("36057, " + i + ", " + name + ", " + flag + ", " + class47 + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }

	public void draw_centered_string(String string, int x, int y, int color) {
		method459((byte) -104, color, string, y - method458(string, -725) / 2, x);
	}

	public void method456(boolean flag, int i, int j, String s, int k) {
    ...
    public void method463(int i, int j, int k, boolean flag, int l, String s)
    {
        try
        {
            ...
            if(aBoolean1480)
            {
                DrawingArea.method414(l - i1, i1, 0x800000, true, k + (int)((double)anInt1478 * 0.69999999999999996D));
                return;
            }
        }
        catch(RuntimeException runtimeexception)
    ...
    public void method464(String s, boolean flag, int i, int j, int k, int l, int i1)
    {
        try
        {
            ...
            random.setSeed(l);
            int k1 = 192 + (random.nextInt() & 0x1f);
            i1 -= anInt1478;
    ...
    {
        int j1 = i + j * DrawingArea.anInt1370;
        int k1 = DrawingArea.anInt1370 - k;
        int l1 = 0;
        int i2 = 0;
        if(j < DrawingArea.anInt1372)
        {
            int j2 = DrawingArea.anInt1372 - j;
            l -= j2;
            j = DrawingArea.anInt1372;
            i2 += j2 * k;
            j1 += j2 * DrawingArea.anInt1370;
        }
        if(j + l >= DrawingArea.anInt1373)
        {
            l -= ((j + l) - DrawingArea.anInt1373) + 1;
        }
        if(i < DrawingArea.anInt1374)
        {
            int k2 = DrawingArea.anInt1374 - i;
            k -= k2;
        ...
        if(i + k >= DrawingArea.anInt1375)
        {
            int l2 = ((i + k) - DrawingArea.anInt1375) + 1;
            k -= l2;
            l1 += l2;
            k1 += l2;
        }
        ...
        {
            method467(DrawingArea.anIntArray1369, abyte0, i1, i2, j1, k, l, k1, l1);
            return;
        }
    }
            ...
            boolean flag)
    {
        try
        {
            ...
            int k1 = i + k * DrawingArea.anInt1370;
            int l1 = DrawingArea.anInt1370 - j1;
            int i2 = 0;
            int j2 = 0;
            if(k < DrawingArea.anInt1372)
            {
                ...
                j2 += k2 * j1;
                k1 += k2 * DrawingArea.anInt1370;
            }
            if(k + l >= DrawingArea.anInt1373)
            {
                l -= ((k + l) - DrawingArea.anInt1373) + 1;
            }
            if(i < DrawingArea.anInt1374)
            {
            ...
            {
                int i3 = ((i + j1) - DrawingArea.anInt1375) + 1;
                j1 -= i3;
                i2 += i3;
                l1 += i3;
            }
            ...
            {
                method469(i2, j1, j, abyte0, false, DrawingArea.anIntArray1369, k1, j2, l1, i1, l);
                return;
            }
        }
        catch(RuntimeException runtimeexception)
