...
public class Class44_Sub3_Sub1_Sub3 extends DrawingArea
{
    ...
    public Class44_Sub3_Sub1_Sub3(Archive class47, String s, int i)
    {
        aBoolean1455 = false;
        aBoolean1456 = false;
        anInt1457 = 9;
        ...
        anInt1464 = class44_sub3_sub2_1.getUnsignedShort();
        anInt1465 = class44_sub3_sub2_1.getUnsignedShort();
        int j = class44_sub3_sub2_1.getUnsignedByte();
        anIntArray1459 = new int[j];
        for(int k = 0; k < j - 1; k++)
        {
            anIntArray1459[k + 1] = class44_sub3_sub2_1.getUnsignedTriByte();
        }
        for(int l = 0; l < i; l++)
        {
        ...
        anInt1460 = class44_sub3_sub2_1.getUnsignedShort();
        anInt1461 = class44_sub3_sub2_1.getUnsignedShort();
        ...
        if(i1 == 0)
        {
            ...
            {
                aByteArray1458[k1] = class44_sub3_sub2.getSignedByte();
            }
            return;
        }
        if(i1 == 1)
        {
            for(int l1 = 0; l1 < anInt1460; l1++)
            {
                ...
                {
                    aByteArray1458[l1 + i2 * anInt1460] = class44_sub3_sub2.getSignedByte();
                }
            }
        }
    }
    ...
    public void method453(int i, byte byte0, int j)
    {
        try
        {
            ...
            {
                method454(i1, anIntArray1459, k, DrawingArea.anIntArray1369, l1, k1, (byte)34, aByteArray1458, j1, l);
                return;
            }
        }
        catch(RuntimeException runtimeexception)
