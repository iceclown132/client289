...
public class Class44_Sub3_Sub4_Sub3 extends Class44_Sub3_Sub4
{
    ...
    public void method501(int i, int j)
    {
        try
        {
            ...
            {
                for(anInt1522 += i; anInt1522 > aClass32_1499.aClass26_563.getLength(anInt1521);)
                {
                    anInt1522 -= aClass32_1499.aClass26_563.getLength(anInt1521) + 1;
                    anInt1521++;
                    if(anInt1521 >= aClass32_1499.aClass26_563.frame_count)
                    {
                        anInt1521 = 0;
                    }
                }
    ...
    public Model method499(int i)
    {
        try
        {
            ...
            if(aClass32_1499.aClass26_563 != null)
            {
                j = aClass32_1499.aClass26_563.frame_index[anInt1521];
            }
            Model class44_sub3_sub4_sub4_1 = new Model(class44_sub3_sub4_sub4, AnimationFrame.invalid(j), false, anInt1497, true);
            if(j != -1)
            {
            ...
            {
                class44_sub3_sub4_sub4_1.scale(aClass32_1499.anInt566, aClass32_1499.anInt566, aClass32_1499.anInt567, (byte)31);
            }
            ...
            {
                class44_sub3_sub4_sub4_1.applyLighting(64 + aClass32_1499.anInt569, 850 + aClass32_1499.anInt570, -30, -50, -30, true);
