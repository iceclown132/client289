...
//        image.setRGB(j1, l1, aByteArrayArrayArray69[i1][j3][k3] * 20);
//		ImageIO.write(image, "png", new FileOutputStream(new File(i1 + ".png")));
//	} catch (Exception ex) {
//		ex.printStackTrace();
//	}
	...
	public LandscapeParser(int ai[][][], int i, byte abyte0[][][], int j) {
		anInt60 = 101;
		aBoolean62 = false;
		aBoolean63 = true;
		anInt66 = j;
	...
	public void method157(int y, int x, int height, int width) {
		for (int x_offset = x; x_offset <= x + width; x_offset++) {
			for (int y_offset = y; y_offset <= y + height; y_offset++) {
				if (y_offset >= 0 && y_offset < anInt66 && x_offset >= 0 && x_offset < anInt67) {
					aByteArrayArrayArray74[0][y_offset][x_offset] = 127;
					if (y_offset == y && y_offset > 0) {
						anIntArrayArrayArray68[0][y_offset][x_offset] = anIntArrayArrayArray68[0][y_offset - 1][x_offset];
					}
					if (y_offset == y + height && y_offset < anInt66 - 1) {
						anIntArrayArrayArray68[0][y_offset][x_offset] = anIntArrayArrayArray68[0][y_offset + 1][x_offset];
					}
					if (x_offset == x && x_offset > 0) {
						anIntArrayArrayArray68[0][y_offset][x_offset] = anIntArrayArrayArray68[0][y_offset][x_offset - 1];
					}
					if (x_offset == x + width && x_offset < anInt67 - 1) {
						anIntArrayArrayArray68[0][y_offset][x_offset] = anIntArrayArrayArray68[0][y_offset][x_offset + 1];
					}
				}
			}
	...
	public static boolean method159(int i, int j, int k, byte[] abyte0) {
		try {
			...
			while (true) {
				...
				while (true) {
					if (flag1) {
						...
						int i2 = j1 & 0x3f;
						int j2 = j1 >> 6 & 0x3f;
						int k2 = buffer.getUnsignedByte() >> 2;
						int l2 = j2 + k;
						int i3 = i2 + j;
			...
			signlink.reporterror("52153, " + i + ", " + j + ", " + k + ", "
					+ abyte0 + ", " + runtimeexception.toString());
			throw new RuntimeException();
		}
	}

    public static void method160(Cache class43_sub1, Buffer class44_sub3_sub2, int i)
    {
        try
        {
            int j;
            ...
            do
            {
                int k = class44_sub3_sub2.getSmart();
                if(k == 0)
                {
                    break;
                }
                ...
                do
                {
                    int l = class44_sub3_sub2.getSmart();
                    if(l == 0)
                    {
                        break;
                    }
    ...
    public void parse_landscape(int offset_x, int offset_y, byte file_data[], Class36 class36, CollisionMap collision_maps[]) {
        Buffer buffer = new Buffer(file_data);
		int object_id = -1;
		while(true) {
			int object_id_offset = buffer.getSmart();
            ...
            while(true)
            {
				int object_location_offset = buffer.getSmart();
				if (object_location_offset == 0) {
					break;
				}
                object_location += object_location_offset - 1;
                int x = object_location & 0x3f;
                int y = object_location >> 6 & 0x3f;
                int z = object_location >> 12;
            
                int object_position = buffer.getUnsignedByte();
                int type = object_position >> 2;
                int rotation = object_position & 3;
                
                int pos_x = y + offset_y;
                int pos_y = x + offset_x;
				if (pos_x > 0 && pos_y > 0 && pos_x < 103 && pos_y < 103) {
					int l3 = z;
					if ((aByteArrayArrayArray69[1][pos_x][pos_y] & 2) == 2) {
						l3--;
					}
					CollisionMap collision_map = null;
					if (l3 >= 0) {
						collision_map = collision_maps[l3];
					}
					method162(type, pos_x, class36, -805, rotation, z, pos_y, collision_map, object_id);
				}
            }
        }
    }

    public void method162(int i, int j, Class36 class36, int k, int orientation, int i1, int j1,
            CollisionMap class18, int k1)
    {
        try
        {
            if(aBoolean64)
            ...
            byte byte0 = (byte)((orientation << 6) + i);
            if(i == 22)
            {
                ...
                {
                    obj = class8.method205(22, orientation, l1, i2, j2, k2, -1);
                } else
                {
                    obj = new Class44_Sub3_Sub4_Sub1(orientation, k1, 22, k2, j2, false, l1, class8.anInt230, true, i2);
                }
                class36.method284(byte0, i3, i1, j1, true, l2, ((Class44_Sub3_Sub4) (obj)), j);
                if(class8.aBoolean224 && class8.aBoolean226 && class18 != null)
                {
                    class18.method234(j, j1);
                }
                return;
            }
            if(i == 10 || i == 11)
            {
                ...
                if(class8.anInt230 == -1 && class8.anIntArray250 == null)
                {
                    obj1 = class8.method205(10, orientation, l1, i2, j2, k2, -1);
                } else
                {
                    obj1 = new Class44_Sub3_Sub4_Sub1(orientation, k1, 10, k2, j2, false, l1, class8.anInt230, true, i2);
                }
                if(obj1 != null)
                {
                    int j5 = 0;
                    ...
                    if(class36.method288(0, j1, j, l2, byte0, i3, j5, k4, i1, ((Class44_Sub3_Sub4) (obj1)), i5) && class8.aBoolean238)
                    {
                        ...
                        {
                            class44_sub3_sub4_sub4 = class8.method205(10, orientation, l1, i2, j2, k2, -1);
                        }
                ...
                {
                    class18.set_object_collision(j1, class8.anInt222, class8.aBoolean225, j, class8.anInt223, orientation);
                }
                return;
            }
            if(i >= 12)
            {
                ...
                if(class8.anInt230 == -1 && class8.anIntArray250 == null)
                {
                    obj2 = class8.method205(i, orientation, l1, i2, j2, k2, -1);
                } else
                {
                    obj2 = new Class44_Sub3_Sub4_Sub1(orientation, k1, i, k2, j2, false, l1, class8.anInt230, true, i2);
                }
            ...
            if(i == 0)
            {
                ...
                if(class8.anInt230 == -1 && class8.anIntArray250 == null)
                {
                    obj3 = class8.method205(0, orientation, l1, i2, j2, k2, -1);
                } else
                {
                    obj3 = new Class44_Sub3_Sub4_Sub1(orientation, k1, 0, k2, j2, false, l1, class8.anInt230, true, i2);
                }
                class36.method286(byte0, anIntArray82[orientation], l2, i3, j, ((Class44_Sub3_Sub4) (obj3)), -927, 0, null, i1, j1);
                if(orientation == 0)
                {
                ...
                if(class8.aBoolean224 && class18 != null)
                {
                    class18.method232(true, orientation, class8.aBoolean225, i, j, j1);
                }
            ...
            if(i == 1)
            {
                ...
                if(class8.anInt230 == -1 && class8.anIntArray250 == null)
                {
                    obj4 = class8.method205(1, orientation, l1, i2, j2, k2, -1);
                } else
                {
                    obj4 = new Class44_Sub3_Sub4_Sub1(orientation, k1, 1, k2, j2, false, l1, class8.anInt230, true, i2);
                }
                class36.method286(byte0, anIntArray83[orientation], l2, i3, j, ((Class44_Sub3_Sub4) (obj4)), -927, 0, null, i1, j1);
                if(class8.aBoolean238)
                {
                    if(orientation == 0)
                    {
            ...
            if(i == 2)
            {
                ...
                if(class8.anInt230 == -1 && class8.anIntArray250 == null)
                {
                    obj11 = class8.method205(2, 4 + orientation, l1, i2, j2, k2, -1);
                    obj12 = class8.method205(2, j3, l1, i2, j2, k2, -1);
                } else
                {
                    obj11 = new Class44_Sub3_Sub4_Sub1(4 + orientation, k1, 2, k2, j2, false, l1, class8.anInt230, true, i2);
                    obj12 = new Class44_Sub3_Sub4_Sub1(j3, k1, 2, k2, j2, false, l1, class8.anInt230, true, i2);
                }
                class36.method286(byte0, anIntArray82[orientation], l2, i3, j, ((Class44_Sub3_Sub4) (obj11)), -927, anIntArray82[j3], ((Class44_Sub3_Sub4) (obj12)), i1, j1);
                if(class8.aBoolean229)
                {
                    if(orientation == 0)
                    {
            ...
            if(i == 3)
            {
                ...
                if(class8.anInt230 == -1 && class8.anIntArray250 == null)
                {
                    obj5 = class8.method205(3, orientation, l1, i2, j2, k2, -1);
                } else
                {
                    obj5 = new Class44_Sub3_Sub4_Sub1(orientation, k1, 3, k2, j2, false, l1, class8.anInt230, true, i2);
                }
                class36.method286(byte0, anIntArray83[orientation], l2, i3, j, ((Class44_Sub3_Sub4) (obj5)), -927, 0, null, i1, j1);
                if(class8.aBoolean238)
                {
                    if(orientation == 0)
                    {
            ...
            if(i == 9)
            {
                ...
                if(class8.anInt230 == -1 && class8.anIntArray250 == null)
                {
                    obj6 = class8.method205(i, orientation, l1, i2, j2, k2, -1);
                } else
                {
                    obj6 = new Class44_Sub3_Sub4_Sub1(orientation, k1, i, k2, j2, false, l1, class8.anInt230, true, i2);
                }
            ...
            if(i == 4)
            {
                ...
                class36.method287(j1, i1, l2, ((Class44_Sub3_Sub4) (obj7)), byte0, anIntArray82[orientation], orientation * 512, i3, 0, anInt61, j, 0);
                return;
            }
            if(i == 5)
            {
                ...
                class36.method287(j1, i1, l2, ((Class44_Sub3_Sub4) (obj13)), byte0, anIntArray82[orientation], orientation * 512, i3, anIntArray84[orientation] * j4, anInt61, j, anIntArray85[orientation] * j4);
                return;
            }
            if(i == 6)
            {
                ...
                class36.method287(j1, i1, l2, ((Class44_Sub3_Sub4) (obj8)), byte0, 256, orientation, i3, 0, anInt61, j, 0);
                return;
            }
            if(i == 7)
            {
                ...
                class36.method287(j1, i1, l2, ((Class44_Sub3_Sub4) (obj9)), byte0, 512, orientation, i3, 0, anInt61, j, 0);
                return;
            }
            if(i == 8)
            {
                ...
                class36.method287(j1, i1, l2, ((Class44_Sub3_Sub4) (obj10)), byte0, 768, orientation, i3, 0, anInt61, j, 0);
                return;
            }
        }
        catch(RuntimeException runtimeexception)
        {
            signlink.reporterror("66723, " + i + ", " + j + ", " + class36 + ", " + k + ", " + orientation + ", " + i1 + ", " + j1 + ", " + class18 + ", " + k1 + ", " + runtimeexception.toString());
            throw new RuntimeException();
        }
    }

    public void method163(byte byte0, CollisionMap aclass18[], Class36 class36)
    {
        try
        {
            if(byte0 != 76)
                ...
                for(int k6 = -5; k6 < anInt66 + 5; k6++)
                {
                    for(int l7 = 0; l7 < anInt67; l7++)
                    {
                        ...
                        if(j9 >= 0 && j9 < anInt66)
                        {
                            ...
                            if(k12 > 0)
                            {
                                Tile class20 = Tile.tiles[k12 - 1];
                                anIntArray76[l7] += class20.phase;
                                anIntArray77[l7] += class20.saturation;
                                anIntArray78[l7] += class20.lightness;
                                anIntArray79[l7] += class20.amplitude;
                                anIntArray80[l7]++;
                            }
                        }
                        int l12 = k6 - 5;
                        if(l12 >= 0 && l12 < anInt66)
                        {
                            ...
                            if(l13 > 0)
                            {
                                Tile class20_1 = Tile.tiles[l13 - 1];
                                anIntArray76[l7] -= class20_1.phase;
                                anIntArray77[l7] -= class20_1.saturation;
                                anIntArray78[l7] -= class20_1.lightness;
                                anIntArray79[l7] -= class20_1.amplitude;
                                anIntArray80[l7]--;
                            }
                        }
                    }
                            ...
                            if(j17 >= 1 && j17 < anInt67 - 1 && (!aBoolean64 || (aByteArrayArrayArray69[k][k6][j17] & 0x10) == 0 && method164(j17, k6, 0, k) == anInt65))
                            {
                                ...
                                if(k18 > 0 || l18 > 0)
                                {
                                    ...
                                    if(k > 0)
                                    {
                                        ...
                                        if(l18 > 0 && !Tile.tiles[l18 - 1].aBoolean435)
                                        {
                                            flag = false;
                                        }
                                    ...
                                    if(i21 != -1)
                                    {
                                        l21 = Rasterizer.anIntArray1439[method170(j21, 96)];
                                    }
                                    if(l18 == 0)
                                    {
                                    ...
                                    } else
                                    {
                                        ...
                                        Tile class20_2 = Tile.tiles[l18 - 1];
                                        int l22 = class20_2.texture_id;
                                        int i23;
                                        int j23;
                                        if(l22 >= 0)
                                        {
                                            j23 = Rasterizer.method424(0, l22);
                                            i23 = -1;
                                        } else
                                        if(class20_2.color_rgb == 0xff00ff)
                                        {
                                            j23 = 0;
                                            i23 = -2;
                                            l22 = -1;
                                        ...
                                        {
                                            i23 = method172(class20_2.hue, class20_2.saturation, class20_2.lightness);
                                            j23 = Rasterizer.anIntArray1439[method171(class20_2.color_hsl, 96)];
                                        }
            ...
            Class36 class36, int k1, int l1)
    {
        try
        {
            ...
            if(l == 10 || l == 11)
            {
                ...
                {
                    class18.set_object_collision(k, class8.anInt222, class8.aBoolean225, j1, class8.anInt223, i);
                }
                return;
            }
            if(l >= 12)
